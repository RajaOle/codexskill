...
- Fast 24/7 response.
- Consistent answers according to SOP.
...
Package name: AI Customer Service + Asisten Internal.

Pro includes all Basic features, plus AI that helps the owner and verified internal team.
...
- automatic quotation creation based on guest count, venue, and add-ons
- partner/vendor coordination and follow-up automation
- vendor and venue matching from partner database
- approval chain and crew workflow adjusted to the business SOP
- custom workflow based on operational needs

## Demo CTA

Customer-safe phrase:

`Siap punya karyawan AI pertama? Bisa jadwalkan demo dan konsultasi gratis dulu, Kak. Promo terbatas: implementation fee hanya Rp 1.000.000.`

## Feature Boundary

Do not claim a feature is already implemented for a client until their onboarding data, SOP, channel login, and custom setup are confirmed.
