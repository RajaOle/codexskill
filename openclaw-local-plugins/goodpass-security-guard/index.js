...
const AGENT_POLICIES = {
  ...
  "moura-alexandra": {
    ...
    allowedReadPatterns: [
      /^(?:knowledge\/mouru\/[^/]+|PRICING_AND_OFFERS|ORDER_ROUTING|PRODUCT_KNOWLEDGE|CLAIMS_AND_COMPLIANCE|CUSTOMER_SERVICE|SALES_PLAYBOOK|COMPETITOR_POSITIONING|CONVERSATION_POLICY|MARKETING|AUDIENCES|EXPRESSIVE_STYLE|WRITINGSTYLE|ROLE|IDENTITY|SCOPE|SECURITY)\.md$/i,
      new RegExp(`^${MOURA_WORKSPACE.replace(/[.*+?^${}()|[\]\\]/g, "\\$&")}/(?:knowledge/mouru/[^/]+|PRICING_AND_OFFERS|ORDER_ROUTING|PRODUCT_KNOWLEDGE|CLAIMS_AND_COMPLIANCE|CUSTOMER_SERVICE|SALES_PLAYBOOK|COMPETITOR_POSITIONING|CONVERSATION_POLICY|MARKETING|AUDIENCES|EXPRESSIVE_STYLE|WRITINGSTYLE|ROLE|IDENTITY|SCOPE|SECURITY)\\.md$`, "i")
    ],
    allowWebTools: true
  },
  "davina-helowedding": {
